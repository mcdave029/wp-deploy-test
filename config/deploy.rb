...
set :wp_sitename, "The Silent Majority" # The site title
set :wp_localurl, "http://localhost/wp-deploy-test" # Your local environment URL
...
set :repo_url, "git@github.com:mcdave029/wp-deploy-test.git"
set :scm, :git
